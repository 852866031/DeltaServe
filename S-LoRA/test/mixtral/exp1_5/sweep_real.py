#!/usr/bin/env python3
"""
Experiment 1.5 — Extended Uniform Config Sweep (Mixtral, REAL WEIGHTS)
=======================================================================
Same grid as sweep.py but uses actual Mixtral-8x7B-v0.1 weights instead
...
MAX_POOL        = 20_000    # KV cache pool size — ~47GB model per GPU + SFT buffers; free_all() for resets
