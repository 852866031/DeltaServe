#!/usr/bin/env python3
"""
Experiment 3 — Irreducible Variance Profiler (Qwen3-30B-A3B EP)
================================================================
Same design as test/mixtral/exp3/variance_profiler.py, but for Qwen3 EP
on 2 GPUs.
...
Log-normal trace: μ=4.5, σ=1.2, clipped to [32, 512].
SLO thresholds tested: [200, 250, 300, 350, 400ms].
...
Usage:
    cd S-LoRA
    python test/qwen3/exp3/variance_profiler.py
"""
...
def print_summary(dist_row, gate_rows_by_budget):
    print("\n" + "=" * 65)
    print("VARIANCE PROFILER — Qwen3-30B-A3B EP (log-normal real trace)")
    print("=" * 65)
