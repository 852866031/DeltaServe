#!/usr/bin/env python3
"""
Experiment 4 — Domain-Specific Routing Variance (Qwen3-30B-A3B EP)
===================================================================
Same design as test/mixtral/exp4/domain_experiment.py but for Qwen3 EP on 2 GPUs.

Key question: does task domain (coding, medical, math, general QA, etc.) affect
Qwen3's MoE routing patterns, creating domain-specific timing variance that the
...
Usage:
    cd S-LoRA
    python test/qwen3/exp4/domain_experiment.py
"""
...
def load_and_tokenize():
    """Load dolly-15k, tokenize instructions with Qwen3 tokenizer, group by domain."""
...
def print_summary(domain_rows, gate_rows):
    print("\n" + "=" * 76)
    print("DOMAIN ROUTING EXPERIMENT — Qwen3-30B-A3B EP (MoE, 2 GPUs)")
    print("=" * 76)
