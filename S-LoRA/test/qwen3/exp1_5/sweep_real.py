#!/usr/bin/env python3
"""
Experiment 1.5 — Extended Uniform Config Sweep (Qwen3-30B-A3B, REAL WEIGHTS)
=============================================================================
Same grid as Mixtral exp1_5/sweep_real.py but uses actual Qwen3-30B-A3B weights.
Qwen3-30B-A3B is a 30B MoE model with 128 experts, top-8 routing, hidden_size=2048,
head_dim=128 (non-standard), and per-head q_norm/k_norm.

Requires 2 GPUs (EP mode, 2 ranks).
...
MAX_TOKENS      = 20_000    # skip if bs * sl exceeds this
MAX_POOL        = 20_000    # KV cache pool size
